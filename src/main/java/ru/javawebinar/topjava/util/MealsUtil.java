...
public class MealsUtil {
    ...
    public static final List<Meal> mealsTwo = Arrays.asList(
            new Meal(LocalDateTime.of(2024, Month.JANUARY, 31, 14, 0), "Обед2", 1000, 2),
            new Meal(LocalDateTime.of(2024, Month.JANUARY, 31, 10, 0), "Завтрак2", 500, 2),
            new Meal(LocalDateTime.of(2024, Month.JANUARY, 31, 20, 0), "Ужин2", 410, 2)
    );
